...
const Home = () => {
  ...
  return (
    <div className="home w-full flex flex-col z-0 items-center justify-evenly text-primary">
      <FromLeftDiv className="w-full px-10 flex flex-col md:flex-row text-center gap-3 md:text-start justify-center items-center" transition={{ type: 'spring', delay: 0.5, duration: 0.5 }}>
        <div className="flex flex-col gap-4 md:w-3/6">
          ...
          <FromRightDiv className="flex flex-col gap-4 items-center md:items-start" transition={{ type: 'spring', delay: 1, duration: 0.5 }}>
